...
{
    public class ParcelOutboundsController : Controller
    {
        private readonly AppDbContext _context;

        public ParcelOutboundsController(AppDbContext context)
        {
            _context = context;
        }

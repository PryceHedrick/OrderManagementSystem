...
namespace OrderManagementSystem.Controllers
{
    public class PlatformOrdersController : Controller
    {
        ...
        {
            return View(await _context.PlatformOrders.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderId")] PlatformOrder platformOrder)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("OrderId")] PlatformOrder platformOrder)
        {

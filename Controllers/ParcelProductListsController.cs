...
{
    public class ParcelProductListsController : Controller
    {
        private readonly AppDbContext _context;

        public ParcelProductListsController(AppDbContext context)
        {
            _context = context;
        }

        // GET: ParcelProductLists
        ...
        // GET: ParcelProductLists/Details/5
        ...
        // POST: ParcelProductLists/Create
        ...
        // POST: ParcelProductLists/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ParcelProductLists/Delete/5
        ...
        // POST: ParcelProductLists/Delete/5
